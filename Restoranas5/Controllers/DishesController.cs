    ...
    public class DishesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Dish != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Dish'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Addition,Rating")] Dish dish)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Addition,Rating")] Dish dish)
        {
            if (id != dish.Id)
            {
                return NotFound();
